...
const zh = {
    ...
    chat: {
        ...
        artifacts: {
            ...
            shelfSummary: '共 {files} 个文件，+{additions} / -{deletions}',
    ...
    skills: {
        ...
        detail: {
            ...
            sectionTriggers: '触发器',
            sectionCompat: '兼容',
            sectionReleaseNotes: '更新日志',
            sectionAudit: '审计',
            sectionAuditRun: '执行审计',
        ...
        import: {
            ...
            action: '导入技能',
            stageTitle: '手动导入技能',
            stageSubtitle: '压缩包和 Git 导入均需先暂存审计再安装。',
            tabArchive: '压缩包',
            tabGit: 'Git 仓库',
            archiveHint: '选择 .zip、.tar.gz、.tgz 或 .tar 格式的技能包。技能将先暂存审计再安装。',
            selectFile: '选择压缩包',
            importing: '暂存中…',
        ...
        inspect: {
            reportTitle: '审计报告',
            sectionSummary: '摘要',
            sectionRecommended: '建议操作',
            sectionFindings: '发现',
            sectionSignals: '信号',
            toolCalls: '工具调用',
            suspiciousFiles: '可疑文件',
            noToolCallHints: '未发现显式工具调用特征。',
    ...
    runbooks: {
        ...
        sending: '发送中…',
        noResults: '没有匹配的手册。',
        emptyState: '还没有运行手册。创建你的第一个吧。',
        empty: '空白手册',
        selectToEdit: '选择一个手册编辑，或创建新手册。',
        bodyLabel: '任务描述',
        bodyPlaceholder: '描述你希望 AI 完成的任务…',
        stepsLabel: '步骤',
    ...
    workflow: {
        ...
        descriptionLabel: '描述',
        descriptionPlaceholder: '简短描述此工作流的用途…',
        searchPlaceholder: '搜索工作流…',
        saving: '保存中…',
        sending: '发送中…',
        noResults: '没有匹配的工作流。',
        emptyState: '还没有工作流。创建你的第一个吧。',
        empty: '空白工作流',
        selectToEdit: '选择一个工作流编辑，或创建新工作流。',
        modeEdit: '编辑',
        modePreview: '预览',
        contentPlaceholder: '使用 Markdown 编写提示词模板…\n\n输入 @ 可插入技能引用，例如 @web-scraper',
        previewEmpty: '*暂无内容*',
        execute: '执行',
        sentToChat: '已发送到对话 — AI 正在工作',
        sendFailed: '发送失败，请确认引擎已就绪。',
    ...
    settings: {
        ...
        profiles: {
            ...
            disconnect: '断开',
            connectTitle: '连接企业',
            connectDesc: '输入企业 Hub 地址即可连接，连接后自动切换到企业环境。',
            connectCta: '连接企业 Hub',
            connectAction: '连接并切换',
            hubUrl: 'Hub 地址',
            label: '显示名称',
