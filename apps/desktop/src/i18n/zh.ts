...
const zh = {
    ...
    chat: {
        ...
        artifacts: {
            ...
            shelfSummary: '共 {files} 个文件，触达 {touches} 次，+{additions} / -{deletions}',
            aggregateError: '文件成果聚合失败',
            sourceTurn: '本轮产出',
            sourceSession: '会话汇总',
            sourceDiff: '会话 diff',
            sourceGit: 'Git 增强',
            sourceSnapshot: '工作区快照',
            sourceAttachment: '工具附件',
            showDiff: '展开 diff',
            hideDiff: '收起 diff',
            copyPath: '复制路径',
            copiedPath: '已复制',
            ...
            diffAfter: '变更后',
            diffEmpty: '无内容',
            noLineStats: '无行级 diff',
            binaryFile: '二进制文件',
            processingSummary: '正在追踪文件变化',
            status: {
                processing: '处理中',
                added: '新增',
                modified: '修改',
    ...
    settings: {
        ...
        profiles: {
            title: '身份与企业连接',
            desc: '本地身份与企业身份并存。切换身份时，工作区、技能、审计报告、内核状态和运行数据全部按 profile 隔离。',
            active: '当前身份',
            identities: '身份列表',
            current: '当前使用中',
            activate: '切换到此身份',
            remove: '移除身份',
            connectTitle: '连接企业 Hub',
            strict: '高审计模式',
            hubUrl: 'Hub 地址',
            catalogPath: '技能目录路径',
            orgId: '企业 ID',
            ...
            userName: '用户名称',
            label: '本地显示名称',
            labelPlaceholder: '例如：Acme 研发 / 张三',
            token: 'Hub Token',
            lockRuntime: '固化运行时设置',
            lockProviders: '锁定供应商与凭据来源',
            lockProvidersUnsupported: '当前手工连接流程还不能下发企业托管的 provider 凭据。请先关闭“锁定供应商”，等 Hub 返回托管凭据后再开启。',
            lockWorkspace: '锁定工作区选择',
            defaultProvider: '默认供应商',
            forcedModel: '强制模型',
            workspaceRoot: '企业工作区根目录',
            workspacePlaceholder: '/Volumes/Enterprise/workspaces/acme',
            notes: '审计说明',
            notesPlaceholder: '例如：禁止切换外部工作区；仅允许企业 Hub 市场技能。',
            connectCta: '连接并切换企业身份',
            unmanaged: '未固化设置',
        },
        engine: {
            title: 'AI 引擎',
